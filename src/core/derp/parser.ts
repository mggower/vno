...
// async function parseApplication(storage: Storage): Promise<ParsedApp> {
...
//     }
//     storage[current.isRoot ? "root" : current.label] = await parseComponent(
//       current,
//       storage,
//       queue,
//     );
