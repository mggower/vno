...
export default {
  ...
  data() {
    return {
      ...
      url: "http://thisurl.com/will/not/be/deleted",
    }
  },
  // this is a javascript comment;
  methods: {
    handelClick: function (event) {
      this.message = event; // this is another javascript comment;
      console.log(this.message);
    },
    /** this is the third js comment */
  }
};
